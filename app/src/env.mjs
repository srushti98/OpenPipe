...
export const env = createEnv({
  ...
  server: {
    ...
    AWS_BUCKET_NAME: z.string().default("placeholder"),
    AWS_REGION: z.string().default("placeholder"),
    AWS_ACCESS_KEY_ID_JSONL: z.string().default("placeholder"),
    AWS_SECRET_ACCESS_KEY_JSONL: z.string().default("placeholder"),
  ...
  runtimeEnv: {
    ...
    AWS_ACCESS_KEY_ID_JSONL: process.env.AWS_ACCESS_KEY_ID_JSONL,
    AWS_SECRET_ACCESS_KEY_JSONL: process.env.AWS_SECRET_ACCESS_KEY_JSONL,
